const CACHE='istanbul-2026-v12';
const ROOT=new URL('./',self.location.href);
const FILES=['./','./index.html','./style.css','./modern.css','./favorites.css','./sync-config.js','./planner.js','./shared-state.js','./favorites.js','./catalog.js','./photos.js','./location.js','./flights.js','./flights.json','./data.js','./app.js','./manifest.webmanifest','./icon.svg','./assets/icon-192.png','./assets/icon-512.png','./assets/icon-maskable.png','./assets/wir-zwei.jpeg','./assets/istanbul-panorama.jpg','./vendor/leaflet.js','./vendor/leaflet.css'];
