...
(() => {
  ...
  $('#open-issues').innerHTML='<div class="issue-strip"><span><strong>3 Punkte noch offen</strong><span class="issue-expanded"> · Kaffeedauer, Ebru und Rücktransfer</span></span><button data-view="bookings">Prüfen ↗</button></div>';
